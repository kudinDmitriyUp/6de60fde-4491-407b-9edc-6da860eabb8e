...
export const metadata: Metadata = {
  title: "Château Alpin - Luxury Swiss Hotel in the Alps",
  description: "Experience unparalleled luxury at Château Alpin, a prestigious Swiss hotel nestled in the heart of the Alps. Michelin-starred dining, world-class spa, and breathtaking mountain views.",
  keywords: "luxury hotel Switzerland, Swiss Alps hotel, premium accommodation, Michelin star restaurant, luxury spa, mountain resort, Château Alpin",
  metadataBase: new URL("https://chateaualpin.ch"),
  alternates: {
    canonical: "https://chateaualpin.ch"
  },
  openGraph: {
    title: "Château Alpin - Luxury Swiss Hotel in the Alps",
    description: "Experience unparalleled luxury at Château Alpin, where timeless elegance meets modern comfort in the heart of the Swiss Alps.",
    url: "https://chateaualpin.ch",
    siteName: "Château Alpin",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763635003416-hqhup8wy.jpg",
        alt: "Château Alpin luxury hotel suite"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Château Alpin - Luxury Swiss Hotel in the Alps",
    description: "Experience unparalleled luxury at Château Alpin, where timeless elegance meets modern comfort in the heart of the Swiss Alps.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763635003416-hqhup8wy.jpg"]
  },
  robots: {
    index: true,
    follow: true
